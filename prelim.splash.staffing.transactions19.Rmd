...
```{r near.peak, echo=FALSE, message=FALSE, warning=FALSE, fig.height= 3.9}
...
```{r Spring.Fri.Sat.Tan.Mid.ApriltoMay, echo=FALSE, warning=FALSE, fig.height= 3.9}
...
```{r Spring.Sundays, echo=FALSE, warning=FALSE, fig.height= 3.9}
