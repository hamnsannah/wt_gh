...
## How did individual products sell in `r year(as.Date(max(data.clean$Date.Sold, na.rm = TRUE)))`?
...
g <- ggplot(data = product.agg.top, aes(x = Product.By.Year, fill = factor(Year))) + 
  ...
  labs(title = "Sales From Top 10 Suppliers By Year", y = "Total Sales", x = "Product By Year") 
print(g)

#product kable calcs
kable.how.many.in.top <- 75
